...
public class GenerateChartsOption {
    public static ChartsOption generateSaleData(FoodService foodService) {
        ...
        chartsOption.setSeries(new ArrayList(){{add(chartsOption.new Series("销量","bar",seriesData));}});
        return chartsOption;
    }
    public static ChartsOption generateIncomeData(List<Orders> allOrders) {
        ...
        chartsOption.setLegend(chartsOption.new Legend(new ArrayList(){{add("收入");}}));
        ...
        chartsOption.setSeries(new ArrayList(){{add(series);}});
        return chartsOption;
